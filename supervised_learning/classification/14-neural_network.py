...
class NeuralNetwork:
    ...
    def gradient_descent(self, X, Y, A1, A2, alpha=0.05):
        """
        A function that performs the gradient descent algorithm
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        """
        A function that trains the neural network for a given number
        of iterations using learning rate alpha.
        """
